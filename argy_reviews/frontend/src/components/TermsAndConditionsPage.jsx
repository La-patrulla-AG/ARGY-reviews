...
const TermsAndConditionsPage = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-center text-gray-800 dark:text-gray-100 mb-4">Términos y Condiciones</h1>
      <p className="text-lg text-center text-gray-600 dark:text-gray-300 mb-8">
        Bienvenido a nuestra página de reseñas. Lea atentamente los siguientes términos y condiciones antes de usar nuestro servicio.
      </p>
      
      <div className="space-y-6">
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">1. Introducción</h2>
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">2. Uso del Servicio</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">3. Responsabilidad del Usuario</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">4. Moderación de Contenido</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">5. Modificaciones de los Términos</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">6. Aceptación de los Términos</h2>
        <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
